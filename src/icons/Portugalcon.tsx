...
export const Portugalcon = forwardRef<SVGSVGElement | null>((props, ref) => (
  <svg
    ...
    <g transform='translate(0 26.7) scale(1.06667)'>
      ...
      <g id='pt_svg__e_745'>
        <g id='pt_svg__d_746' fill='#ff0' stroke='#000' stroke-width='.5'>
          ...
          <path id='pt_svg__a_747' d='M191 141.6v3.4h-4v-3.4h4z'></path>
          <use width='100%' height='100%' x='10.6'></use>
          <path
            id='pt_svg__b_748'
        ...
        <use width='100%' height='100%' y='46.3'></use>
        <use
          width='100%'
          height='100%'
      ...
      <use width='100%' height='100%' x='45.7'></use>
      <use
        width='100%'
        height='100%'
        transform='matrix(-1 0 0 1 479.8 0)'
      ></use>
      <g id='pt_svg__f_750' fill='#fff'>
        <path
          fill='#039'
      ...
      <use width='100%' height='100%' y='-26'></use>
      <use width='100%' height='100%' x='-20.8'></use>
      <use width='100%' height='100%' x='20.8'></use>
      <use width='100%' height='100%' y='25.8'></use>
    </g>
  </svg>
));
